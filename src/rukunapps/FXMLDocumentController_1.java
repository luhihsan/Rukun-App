...
public class FXMLDocumentController_1 implements Initializable {
    ...
    void lihatAkun(ActionEvent event) {
        PindahHalaman h = new PindahHalaman();
        h.pindahHalaman(event, "SceneLihatAkun_1.fxml");
